...
async function main(){
    ...
    // modal button event
    modalClassmateArea_div.addEventListener('click', async (e) => { await modalButtonEvent(e, activeUser, classmates, otherUsers); }, false);
    // user button event
    userArea_div.addEventListener('click', async (e) => { await userButtonEvents(e, activeUser, otherUsers, classmates); }, false);
    ...
    // close window event
    window.addEventListener('beforeunload', async (e)=>{ await unloadEvent(e, activeUser, otherUsers); }, false);
