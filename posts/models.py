...
class Thread(models.Model):
    ...
    thread_date = models.DateTimeField('Posted: ')
    threadTopic = models.CharField(max_length=200, default=' ')
    currentPostNumber = models.IntegerField(default=0)
    main_post_id = models.IntegerField(default=0)  #might be a better way to do this later
...
class Post(models.Model):
    ...
    post_date = models.DateTimeField('published:')
...
class Message(models.Model):
    ...
    message_date = models.DateTimeField('published:')
    main_text = models.TextField()
